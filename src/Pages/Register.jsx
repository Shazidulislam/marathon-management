          ...
          <div className="w-full max-w-lg p-4 rounded-md shadow sm:p-8 bg-gray-100 mx-auto text-gray-800">
                ...
                <form onSubmit={handleRegister} action="" className="space-y-8">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <label htmlFor="name" className="block text-sm">Potho URL</label>
                            <input type="url" name="pothourl"  placeholder="Potho URL" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-violet-600" />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <input type="text" name="password"  placeholder="*****" className="w-full px-3 py-2 border rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-violet-600" />
                        </div>
                    </div>
